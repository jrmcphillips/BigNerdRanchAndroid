...
public class CrimeListFragment extends ListFragment {
    private class CrimeAdapter extends ArrayAdapter<Crime> {
        public CrimeAdapter(final CrimeMap crimeMap) {
            super(getActivity(), R.layout.list_item_crime, new ArrayList(
                    crimeMap.values()));
        }
        ...
        public View getView(final int position, View convertView,
            ...
            final TextView titleTextView = (TextView) convertView
            ...
            final CheckBox solvedCheckBox = (CheckBox) convertView
                    .findViewById(R.id.crime_list_item_solved_check_box);
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        final CrimeAdapter crimeAdapter = new CrimeAdapter(
    ...
    @Override
    public void onListItemClick(final ListView listView, final View v,
